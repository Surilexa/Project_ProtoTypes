...
{
	instance_activate_layer(layer_get_id("DrinkShop_Window"));
	instance_activate_layer(layer_get_id("DrinkShopBack"));
	merchantWindow = true;
...
{
	instance_deactivate_layer(layer_get_id("DrinkShop_Window"));
	instance_deactivate_layer(layer_get_id("DrinkShopBack"));
